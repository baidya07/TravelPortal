                ...
                child: AppBar(
                  ...
                  actions: [
                    IconButton(
                      onPressed: () {},
                      icon:
                          SvgPicture.asset(UIAssets.getSvg('notification.svg')),
                    ),
                  ],
                ),
              ),
          ...
          Column(
            ...
            children: [
              Stack(children: [
                ...
                Positioned(
                  left: 125,
                  child: SvgPicture.asset(UIAssets.getSvg('$bookmark')),
        ...
        Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'For all internation holiday flight and hotel booking',
                  style: Theme.of(context)
                      .textTheme
                      .caption!
                      .copyWith(color: Colors.white),
